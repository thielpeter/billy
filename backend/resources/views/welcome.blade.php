            ...
            <div class="row mb-n2">
                    ...
                    <div class="card card-style gradient-blue shadow-bg shadow-bg-l">
                        <div class="content">
                            <a href="#" data-menu="menu-dates">
                                ...
                                <p class="color-white">
                                    This box is a gradient. Any color can be composed to a gradient from the color packs
                                    included.
                                </p>
                            </a>
                        </div>
                ...
                <div class="col-6 ps-2">
                    <div class="card card-style gradient-blue shadow-bg shadow-bg-l">
                        <div class="content">
                            <a href="#" data-menu="menu-dates">
                                <h4 class="color-white">Generate Invoice</h4>
                                <p class="color-white">
                                    This box is a gradient. Any color can be composed to a gradient from the color packs
                                    included.
                                </p>
        ...
        <div id="menu-dates" class="menu menu-box-bottom menu-box-detached">
            <form method="post" target="/">
                <div class="menu-title"><h1>Track it </h1>
                    <p class="color-theme opacity-40">Track it</p><a href="#" class="close-menu"><i
                ...
                <div class="content mt-2">
                    ...
                    <a href="/submit" data-menu="menu-manage"
